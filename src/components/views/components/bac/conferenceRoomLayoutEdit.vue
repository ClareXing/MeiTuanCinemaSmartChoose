            ...
            <el-row>
               <el-col :span="14">
                  <el-form  label-position="left" label-width="0px">
                   <el-form-item label="U开口方向" v-show="seatModelInfo.seatModelType==='uShape'" label-width="110px" >
    ...
    computeWall() {
      ...
      if (this.seatTemplate.layoutArray) {
        ...
        if (right === 0 && left === 0 && bottom === 0 && top === 0) {
          ...
          this.seatTemplate.wallWidth = right - left + 4;// 围墙长度
          this.seatTemplate.wallHeight = bottom - top + 4;// 围墙高度
